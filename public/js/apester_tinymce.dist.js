...
(function() {
    angular.module('apesterWpApp')
      .constant('configuration', {
        ...
        tokenBaseUrl: (window.location.protocol) + '//users.apester.com/publisher/token/',
        interactionBaseUrl: (window.location.protocol) + '//interaction.apester.com/',
        interactionsByTokenUrl: 'interaction/all/token?',
        eventsBaseUrl: (window.location.protocol) + '//gcp-events.apester.com/event',
      });
})();
(function() {
  angular.module('apesterWpApp')
